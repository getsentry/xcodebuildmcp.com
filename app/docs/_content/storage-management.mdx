...
<PageHeader
  ...
  lede="Use the interactive cleaner to review and remove XcodeBuildMCP-managed workspace storage when isolated build artifacts, logs, result bundles, or temporary state start taking too much disk space."
/>

<Callout variant="info" title="Why XcodeBuildMCP uses workspace-scoped storage">
