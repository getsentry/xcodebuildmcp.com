...
<PageHeader
  ...
  lede="Upgrading from XcodeBuildMCP 1.x to 2.x. Two breaking changes; most users only need the first."
/>
...
xcodebuildmcp ui-automation tap --simulator-id <UDID> --element-ref e12
```
