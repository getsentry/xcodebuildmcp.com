...
<PageHeader
  ...
  title="Setup"
  lede="You've installed XcodeBuildMCP. Here's how to wire it into your editor, configure defaults for your project, and run your first build."
/>
...
If the server doesn't start or tools don't appear, see [Troubleshooting](/docs/troubleshooting). Always paste `xcodebuildmcp doctor` output when filing an issue.
