...
<PageHeader
  ...
  title="Agent Skills"
  lede="Prime your agent with XcodeBuildMCP's conventions so it stops guessing flag names."
/>

XcodeBuildMCP ships with two optional [agent skills](https://agentskills.io/home):
...
- The upstream skill sources live in [skills/](https://github.com/getsentry/XcodeBuildMCP/tree/main/skills).
