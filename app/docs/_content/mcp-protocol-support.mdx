...
The [Xcode IDE bridge](/docs/xcode-ide) still uses the XcodeBuildMCP envelope for bridge tool results, but proxied remote-tool payloads inside `data` come from Xcode's own MCP service.
