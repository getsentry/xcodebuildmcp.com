...
<PageHeader
  ...
  title="Configuration"
  lede="Everything XcodeBuildMCP reads on startup: the config file, where values come from, and how layers combine."
/>
...
| [Environment Variables](/docs/env-vars) | Every env var XcodeBuildMCP reads, including MCP client bootstrap |
