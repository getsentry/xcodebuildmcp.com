...
Some MCP clients have short tool timeouts. If you see `timed out awaiting tools/call after 60s`, `timed out awaiting tools/call after 120s`, or similar in Codex, set the timeout inside the XcodeBuildMCP server block:
